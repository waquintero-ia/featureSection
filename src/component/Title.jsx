const Title = () =>{
  ...
  const composition_description = 'font-regular text-15 tracking-[0.1px] leading-[167%] opacity-50'
  const composition_title_sm = 'sm:w-[37.5vw]'

  return(
    <>
      <article className={`title flow__title ${composition_title} ${composition_title_sm}`}>
